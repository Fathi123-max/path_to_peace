    ...
    return Scaffold(
      body: Stack(
        children: [
            ...
            child: AnimatedBuilder(
              ...
              builder: (_, __) => Transform.scale(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(color: AppColors.primaryTeal.withOpacity(0.3), shape: BoxShape.circle),
                ),
              ),
            ),
          ),
          Positioned(
            ...
            child: AnimatedBuilder(
              ...
              builder: (_, __) => Transform.scale(
                ...
                child: Container(
                  width: 384.w, height: 384.h,
                  decoration: BoxDecoration(color: const Color(0xFFF6C85F).withOpacity(0.3), shape: BoxShape.circle),
                ),
              ),
            ),
          ),
                              ...
                              children: [
                                Flexible(
                                  child: Text(
                                    ...
                                    style: GoogleFonts.inter(fontSize: 28.sp, fontWeight: FontWeight.w700, color: const Color(0xFF334155), height: 1.2),
                                  ),
                                ),
                                SizedBox(height: 16.h),
                                Text(_quote?.source ?? "Prophet Muhammad (ﷺ)", 
                                    textAlign: TextAlign.center,
                                    style: GoogleFonts.lato(fontSize: 16.sp, color: const Color(0xFF64748B))),
                              ],
                            ),
                          ),
                        ),
          ...
          // Share button
          Positioned(bottom: 100.h, right: 16.w, child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: AppColors.primaryTeal, shape: BoxShape.circle, boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.1), blurRadius: 4, offset: Offset(0, 2))]),
